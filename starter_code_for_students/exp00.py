...
class NeuralNet:
    ...
    def _initialize_architecture(input_size, output_size):
        ...
        architecture = nn.Sequential(
            nn.Linear(in_features=input_size, out_features=200),  # Layer with 1000 nodes.
            nn.ReLU(),  # Apply ReLU activation to previous layer.
            nn.Linear(in_features=200, out_features=150),  # Layer with 750 nodes.
            nn.ReLU(),  # Apply ReLU activation to previous layer.
            nn.Linear(in_features=150, out_features=output_size)  # Output layer with 1 node.
        )
        return architecture
